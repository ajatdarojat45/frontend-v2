...
export function GeometrySelectionInfo() {
  ...
  if (!selectedGeometry || selectedGeometry.mesh?.visible === false) {
    return (
      <Card className="w-80 border border-transparent bg-gradient-to-r from-choras-primary from-50% to-choras-secondary bg-clip-border p-0.5">
        <div className="bg-white w-full py-6 rounded-lg space-y-2">
          <CardHeader>
