      ...
      <div className="h-full flex flex-col rounded-md bg-white/65 text-slate-700 font-inter p-2">
        <div className="min-h-0 flex flex-1 flex-col pr-1">
          ...
          >
            ...
            {/* issue list */}
            <div
              className={hasExpandedIssueGroups ? "min-h-0 flex-1" : ""}
                    ...
                    <tbody>
                      {geometryIssues &&
                        Object.entries(geometryIssues).map((el) => {
                          ...
                          const groupedIssues = issues.reduce((acc, issue, index) => {
                          ...
                          const issueRows = Array.from(groupedIssues.values()).map((group) => {
                            ...
                            return {
                              ...
                              types: Array.from(
                                new Set(group.map((groupIssue) => groupIssue.type)),
                              ),
                                ...
                                issueRows.map((issueRow, index) => {
                                  ...
                                  return (
                                    <tr
                                      key={`${issueType}-${index}`}
                                      onClick={() =>
                                        handleIssueClick(isSelected, issueRow.issueForSelection)
                                      }
